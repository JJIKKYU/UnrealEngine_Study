...
// Cross Module References
	BASICSTUDY_API UClass* Z_Construct_UClass_ASnail_NoRegister();
	BASICSTUDY_API UClass* Z_Construct_UClass_ASnail();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_BasicStudy();
	BASICSTUDY_API UClass* Z_Construct_UClass_UKillable_NoRegister();
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASnail_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ASnail_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UKillable_NoRegister, (int32)VTABLE_OFFSET(ASnail, IKillable), false },
		};
	...
	IMPLEMENT_CLASS(ASnail, 1085748002);
	template<> BASICSTUDY_API UClass* StaticClass<ASnail>()
	{
		return ASnail::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASnail(Z_Construct_UClass_ASnail, &ASnail::StaticClass, TEXT("/Script/BasicStudy"), TEXT("ASnail"), false, nullptr, nullptr, nullptr);
