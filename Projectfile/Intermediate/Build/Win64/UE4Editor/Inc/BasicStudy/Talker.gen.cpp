...
// Cross Module References
	...
	BASICSTUDY_API UClass* Z_Construct_UClass_UTalker();
	COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
	UPackage* Z_Construct_UPackage__Script_BasicStudy();
	BASICSTUDY_API UFunction* Z_Construct_UFunction_UTalker_StartTalking();
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTalker_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTalker_StartTalking, "StartTalking" }, // 2532471603
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UTalker, 1707380733);
	template<> BASICSTUDY_API UClass* StaticClass<UTalker>()
	{
		return UTalker::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UTalker(Z_Construct_UClass_UTalker, &UTalker::StaticClass, TEXT("/Script/BasicStudy"), TEXT("UTalker"), false, nullptr, nullptr, nullptr);
