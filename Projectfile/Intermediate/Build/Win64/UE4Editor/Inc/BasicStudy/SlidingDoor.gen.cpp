...
#include "BasicStudy/SlidingDoor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	BASICSTUDY_API UClass* Z_Construct_UClass_ASlidingDoor_NoRegister();
	BASICSTUDY_API UClass* Z_Construct_UClass_ASlidingDoor();
	ENGINE_API UClass* Z_Construct_UClass_AStaticMeshActor();
	UPackage* Z_Construct_UPackage__Script_BasicStudy();
	BASICSTUDY_API UFunction* Z_Construct_UFunction_ASlidingDoor_Open();
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASlidingDoor_Statics::NewProp_bIsOpen_MetaData[] = {
		{ "ModuleRelativePath", "SlidingDoor.h" },
	};
#endif
	void Z_Construct_UClass_ASlidingDoor_Statics::NewProp_bIsOpen_SetBit(void* Obj)
	{
		((ASlidingDoor*)Obj)->bIsOpen = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ASlidingDoor_Statics::NewProp_bIsOpen = { "bIsOpen", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ASlidingDoor), &Z_Construct_UClass_ASlidingDoor_Statics::NewProp_bIsOpen_SetBit, METADATA_PARAMS(Z_Construct_UClass_ASlidingDoor_Statics::NewProp_bIsOpen_MetaData, ARRAY_COUNT(Z_Construct_UClass_ASlidingDoor_Statics::NewProp_bIsOpen_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASlidingDoor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASlidingDoor_Statics::NewProp_bIsOpen,
	};
	...
	IMPLEMENT_CLASS(ASlidingDoor, 3703981851);
	template<> BASICSTUDY_API UClass* StaticClass<ASlidingDoor>()
	{
		return ASlidingDoor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASlidingDoor(Z_Construct_UClass_ASlidingDoor, &ASlidingDoor::StaticClass, TEXT("/Script/BasicStudy"), TEXT("ASlidingDoor"), false, nullptr, nullptr, nullptr);
