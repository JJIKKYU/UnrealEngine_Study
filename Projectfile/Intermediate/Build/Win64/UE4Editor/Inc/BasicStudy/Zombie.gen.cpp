...
// Cross Module References
	BASICSTUDY_API UClass* Z_Construct_UClass_AZombie_NoRegister();
	BASICSTUDY_API UClass* Z_Construct_UClass_AZombie();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AZombie_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AZombie_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UUndead_NoRegister, (int32)VTABLE_OFFSET(AZombie, IUndead), false },
		};
	...
	IMPLEMENT_CLASS(AZombie, 407156022);
	template<> BASICSTUDY_API UClass* StaticClass<AZombie>()
	{
		return AZombie::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AZombie(Z_Construct_UClass_AZombie, &AZombie::StaticClass, TEXT("/Script/BasicStudy"), TEXT("AZombie"), false, nullptr, nullptr, nullptr);
