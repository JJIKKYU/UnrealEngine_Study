...
// Cross Module References
	BASICSTUDY_API UClass* Z_Construct_UClass_ASpotter_NoRegister();
	BASICSTUDY_API UClass* Z_Construct_UClass_ASpotter();
	ENGINE_API UClass* Z_Construct_UClass_AStaticMeshActor();
	UPackage* Z_Construct_UPackage__Script_BasicStudy();
	BASICSTUDY_API UFunction* Z_Construct_UFunction_ASpotter_OnPlayerSpotted();
...
// End Cross Module References
	...
	IMPLEMENT_CLASS(ASpotter, 2154791850);
	template<> BASICSTUDY_API UClass* StaticClass<ASpotter>()
	{
		return ASpotter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASpotter(Z_Construct_UClass_ASpotter, &ASpotter::StaticClass, TEXT("/Script/BasicStudy"), TEXT("ASpotter"), false, nullptr, nullptr, nullptr);
